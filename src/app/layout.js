...
export const metadata = {
  title: "Virtuo Services Business Consulting NextJs Template",
...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <Head>
        <title>Virtuo Services Business Consulting NextJs Template</title>
        <meta name="author" content="themewant" />
        <meta name="description" content="Virtuo Services Business Consulting NextJs Template" />
